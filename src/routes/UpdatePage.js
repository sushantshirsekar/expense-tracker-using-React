...
const UpdatePage = () => {
    ...
    const submitHandler = (event) => {
        ...
        fetch('https://identitytoolkit.googleapis.com/v1/accounts:update?key=AIzaSyBWGYRRzV87ZdrnvV_7QsU_lrt4uA9A2b4', {
            method: 'POST', 
            body : JSON.stringify({
                idToken: storageId, 
  ...
  return (
    ...
    <Form onSubmit={submitHandler}>
      ...
      <Form.Group className="mb-3" controlId="formPhotoUrl">
        ...
        <Form.Control type="text" placeholder="Update Photo Url" ref={picref}/>
      </Form.Group>
